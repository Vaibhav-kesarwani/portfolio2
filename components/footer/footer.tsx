...
export default function Footer() {
  return (
    <div className="mt-24 border-t border-white/10 p-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-16 items-start">
            ...
            >
              ...
              <p className="mt-8 max-w-md text-white/60 leading-relaxed font-semibold tracking-tight">
                ...
                make a difference, and turning ideas into reality — where every
                pixel has a purpose and every interaction tells a story.
              </p>
            </div>
